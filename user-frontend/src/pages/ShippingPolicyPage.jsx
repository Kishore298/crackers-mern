  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="w-full md:max-w-[70%] mx-auto px-4 sm:px-6 py-12 space-y-8 text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="font-heading font-bold text-2xl text-gray-900 mb-4">1. Dispatch Process</h2>
        ...
        <section>
          <h2 className="font-heading font-bold text-2xl text-gray-900 mb-4">3. Delivery Timelines</h2>
          <p>
        ...
        <section>
          <h2 className="font-heading font-bold text-2xl text-gray-900 mb-4">4. Shipping Charges</h2>
          <p>
