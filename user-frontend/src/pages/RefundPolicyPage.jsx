    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-surface border-b border-orange-100 py-10 md:py-16">
        <div className="w-full md:max-w-[70%] mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-600">Please review our rules regarding order cancellations.</p>
        </div>
      </div>
      ...
      <div className="w-full md:max-w-[70%] mx-auto px-4 sm:px-6 py-12 space-y-8 text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="font-heading font-bold text-2xl text-gray-900 mb-4">1. Order Cancellations</h2>
        ...
        <section>
          <h2 className="font-heading font-bold text-2xl text-gray-900 mb-4">2. Damaged or Defective Items</h2>
          <p>
        ...
        <section>
          <h2 className="font-heading font-bold text-2xl text-gray-900 mb-4">3. Refund Process</h2>
          <p>
        ...
        <section>
          <h2 className="font-heading font-bold text-2xl text-gray-900 mb-4">4. Returns</h2>
          <p>
