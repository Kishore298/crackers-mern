    ...
    <div className="min-h-screen animate-fade-in-up" style={{ background: "#0a0814" }}>
      ...
      <div className="py-10 md:py-16" style={{ background: "#13111f", borderBottom: "1px solid rgba(255,102,0,0.1)" }}>
        <div className="w-full md:max-w-[70%] mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-gray-400">Please read these terms carefully before using our website.</p>
        </div>
      </div>
      ...
      <div className="w-full md:max-w-[70%] mx-auto px-4 sm:px-6 py-12 space-y-8 text-gray-300 leading-relaxed">
        ...
        <section>
          <h2 className="font-heading font-bold text-2xl text-white mb-4">2. Legal Age Requirement</h2>
          <p>
        ...
        <section>
          <h2 className="font-heading font-bold text-2xl text-white mb-4">3. Products and Pricing</h2>
        ...
        <section>
          <h2 className="font-heading font-bold text-2xl text-white mb-4">4. Payment Terms</h2>
          <p>
        ...
        <section>
          <h2 className="font-heading font-bold text-2xl text-white mb-4">6. Jurisdiction</h2>
          <p>
