...
const FloatingWhatsApp = () => (
  <div className="fixed bottom-8 right-8 z-50 flex items-center justify-center">
    ...
    <a
      ...
      className="relative z-10 bg-[#25D366] text-white rounded-full shadow-lg hover:scale-110 transition-transform flex items-center justify-center cursor-pointer"
